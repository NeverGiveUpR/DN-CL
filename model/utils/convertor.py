...
class Convertor:
    ...
    def convert(self, preds, reg_preds, points, const_opt_points, logits, return_all: bool = False, use_clean_points_opt_const: bool = True):
...
class BestFittingFilter(Convertor):
    ...
    def convert(self, preds, reg_preds, points, const_opt_points, logits, return_all: bool = False, use_clean_points_opt_const: bool = True):
        ...
        const_opt_points = const_opt_points.numpy()
