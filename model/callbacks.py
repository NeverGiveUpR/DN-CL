...
from .utils.noise_adder import adding_gaussian_noise_portion, add_noise_to_half_batches
...
class EvalDatasetWithoutTeacherForcing(tf.keras.callbacks.Callback):
    ...
    def update_metrics(self, data):
        ...
        noise_points = add_noise_to_half_batches(points)
        # noise_points = adding_gaussian_noise_portion(points)
        ...
        (
            ...
            preds_inorder,
            preds_symbolic,
        ) = self.search.batch_decode(noise_points, const_opt_points = noise_points)
