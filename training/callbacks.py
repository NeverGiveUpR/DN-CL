...
def get_callbacks(
    ...
    # home_path = '/home/liujingyi/symformer-main-noise/symformer-main'
    # directory_path = '{}/my_checkpoints/batch{}'.format(home_path,config.dataset_config.batch_size)
    # if not os.path.exists(directory_path):
    #     os.makedirs(directory_path)

    # model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    #     filepath='{}/weights.h5'.format(directory_path),
